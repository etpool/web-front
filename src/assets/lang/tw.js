  ...
  home: {
    ...
    text33: '',
            ...
            sectionPage: {
                ...
                newsTitle: "多終端APP",
                brandTitle: "關於幣火",
                brandDetail: "幣火團隊擁有敏銳的洞察力並只把優質的區塊鏈資產帶入幣火生態中",
                brandDesc1: "",
                brandDesc2: "幣火是一家只聚集優質區塊鏈資產面並向全球的交易所，像是近期非常熱門的NFT相關項目、元宇宙、Web3等等，都是我們洞察團隊每日追踪的領域之一，而我們的使命之一是只會引進“優質的區塊鏈資產項目” ，幣火的創辦團隊來自8年老牌交易所的內部開發人員，我們擁有豐富經營交易所的經驗並致力於打造一個強大，安全與穩定的交易所給全球的用戶。",
                brandDesc3: "",
                gettingstart: "新手指引 | 極速學習",
                officialstart: "即刻開啟數字貨幣交易學習",
                oneminutebuy: "暗号通貨とは何ですか",
                oneminutebuytips: "3分で暗号通貨について学ぶ",
                baseknow: "Bihuo新しいユーザーガイド",
                baseknowtips: "いつでもどこでも旅を始めましょう",
                baseexchange: "デジタル資産の購入",
                baseexchangetips: "デジタル資産の購入方法",
                usersocial: "パートナーメカニズム",
                usersocialtips: "Bihuoパートナーになる",
                mainboard: "主板交易區",
                preview: "上一頁",
                nextpage: "下一頁",
            ...
            activity: {
                ...
                submit: "提交",
                tipsmobile: "請進入電腦端頁面參與",
                tipsmobile1: "請在電腦端打開並進入創新實驗區參與",
                intvalue: "請輸入整數",
            ...
            invite: {
                ...
                partnerlevel: "合夥級別",
                ruledetail: "規則詳情",
                ruleprofile1: "幣嚴BinaricX的【推廣合夥人】是全網",
                ruleprofile2: "返佣比例最高、",
                ruleprofile3: "返佣時長最長(最高終身返佣)",
                ruleprofile4: "的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受與幣嚴BinaricX交易平台共同成長的紅利！具體細則如下：",
                ruletext1: "一、為佈道數字資產理念與擴大用戶規模，BinaricX推出【推廣合夥人】計劃，該活動長期有效。",
                ruletext2: "二、邀請好友分為一級，如A邀請B，則B是A的一級好友。",
                ruletext3: "三、推廣好友註冊時，需通過邀請者提供的鏈接或手動輸入邀請者邀請碼方可成為邀請者的一級好友。",
                ruletext4: "四、被邀請者通過邀請者邀請碼註冊，返佣激勵方可生效。",
                ruletext5: "",
                ruletext6: "五、推廣返佣資產為下級好友幣幣交易手續費，返佣幣為三大市場基礎幣，即：USDT、BTC、ETH。",
                ruletext7: "六、推廣返佣比例如下：",
                ruletext8: "七、推廣返佣排行榜TOP10或TOP100不定期會獲得由BinaricX官方發放的額外獎勵。",
                ruletext9: "八、如其他活動與【推廣合夥人】活動衝突，則經協商後決定是否臨時變更，望諸合夥人諒解。",
                ruletext10: "",
                ruletext11: "九、本活動最終解釋權歸BinaricX所有。",
                ruleexampletitle: "舉例說明：",
                ruleexamplecontent1: "若用戶小嚴邀請了100名一級好友，此時小嚴就擁有100名一級好友。如果平均每人每天交易3000元，那麼小嚴月收入約：(100*3000*0.001*30%) * 30 = 2700/月。",
                ruleexamplecontent2: "",
                lastupdate: "最後更新於",
                laststastic: "統計截止時間",
                level: "級別",
                ...
                pt_card_rule2: "二、免費禮品卡每個用戶限兌1份。由幣嚴BinaricX官方發放的免費禮品卡，每個用戶限兌一份，即使通過不同用戶領取到不同兌換碼的免費禮品卡，也只能兌換1份。自定義製作禮品卡不受此限制。",
                ...
                pt_card_rule6: "六、免費禮品卡最終解釋權歸BinaricX所有。",
                pt_card_day: "天",
            ...
            uc: {
                ...
                finance: {
                    ...
                    withdraw: {
                        ...
                        numtip3: "提幣數量不得小於手續費",
                        amounttip: "請輸入提幣數量",
                        moneyttip: '提幣數量必須大於手續費',
                        moneyminttip: '最小提現金額為',
                        moneymaxttip: '最大提現金額為',
                        shenqing: '提幣申請已提交',
                        feetip1: "手續費最小值為",
                        feetip2: "最大值為",
                        time: "提現時間",
                ...
                safe: {
                    ...
                    save_success: "保存成功!",
                    save_failure: "保存失敗!",
                    idcard_verifymsg1: "1、支持JPG、PNG格式，文件小於2M；證件上的信息，清晰可見，不允許任何修改和遮擋，必須能看清證件號和姓名。",
                    idcard_verifymsg2: "2、照片需免冠，建議未化妝，手持證件人的五官清晰可鑑，完整露出手臂。",
                    idcard_verifymsg3: "3、需要同時手持證件和手寫文案（BinaricX+姓名+申請日期）'我在本站的所有行為均為本人操作，並已知悉相關風險，願意承擔本賬戶的一切法律後果。 '"
                },
                account: {
                    pagetitle: "綁定實名帳號",
            ...
            description: {
                ...
                title3: '快捷的交易充提系統',
                title4: '24*7小時客服支持',
                message1: '用戶只會交易經由幣火專業的分析團隊篩選後優質的區塊鏈項目。',
                message2: '幣火用戶的資金安全性來自於我們成熟的資金分離系統。',
                message3: '客戶充提的速度是我們很重視的，幣火的系統24小時實時工作。',
                message4: '用戶第一是我們幣火的經營核心理念之一，我們提供全天24小時的客服支持。',
                scanqrcode: "掃描二維碼，下載APP",
                aboutdesc1: "BinaricX榜利以安全，公平，易用的數字資產交易服務為核心使命，為全球數字資產交易用戶提供可信賴的舒適投資交易環境。",
                aboutdesc2: "數字資產領域日新月異，唯有高瞻遠矚、迅捷前行才能跟上迅猛的科技創新，BinaricX榜利為我們的用戶及全球投資者提供最先進的數字資產交易服務以及業務。",
                aboutdesc3: "BinaricX 榜利建立了堅實可靠的基礎，為未來的發展做好準備，我們將會聚焦更多數字金融體系的優勢於平台，為全球用戶提供數字申購，法幣，幣幣及金融衍生品等數字交易服務，並持續性為用戶帶來全新體驗。",
                support: "技術支持",
                report: "投訴建議",
                service: "客戶服務",
                apply: "上幣申請",
                ...
                community: "幣嚴社區",
                wechat: "微信",
                addwechat: "添加 “BinaricX01” 為微信好友，進入微信福利社群",
                facebook: "面子書",
                weibo: "微博",
                twitter: "推特",
                biyong: "幣用",
                ...
                instagram: "Instagram",
                reddit: "Reddit",
                download1: "隨時隨地 多平台終端交易",
                download2: "覆蓋iOS、Android多個平台，支持全業務功能",
            },
            bzb_description: {
                title1: "分紅權益",
                title2: "手續費折扣",
                ...
                desc4: "參與BinaricX社區投票活動，包括但不限於上幣、回購等",
            ...
            index: {
                ...
                BHBregister: "BinaricX賬戶註冊",
                tibi: "提幣到賬時間及限額",
                line_plane: "BHB上線計劃、流通量及手續費返還公告",
                fenpeijizhi: "關於BinaricX收入分配機制的說明",
                jiangli_jihua: "邀請挖礦獎勵計劃",
                friend_fanhuan: "邀請好友、賺取額外手續費返還"
            },
            plate: {
                title: "平台收入分配方案 (BHB 持有者權益)",
                content1: "正如白皮書所描述的，BinaricX會拿出平台的80% (扣除稅費後) 的收入分配給BinaricX持有者，20%的收入用來支持平台的研發及運營。",
