module.exports = {
    common: {
        ...
        set: 'Set',
        update: 'Modify',
        slogan: "Buy Coins on Bihuo",
        subslogan: "Gather the most potential digital assets",
        more: "More",
        please: "Please",
        pleaseselect: "Select",
        inputpleaseselect: "please enter",
        searchplaceholder: "Search",
        searchplaceholderswap: "Search",
        loading: "Loading...",
        close: "Close",
        ok: "OK",
        footer1: "",
  ...
  home: {
    ...
    sectionPage: {
        ...
        brandTitle: "About Bihuo",
        brandDetail: "The Bihuo team has keen insight and only brings high-quality blockchain assets into the Bihuo ecosystem",
        brandDesc1: "",
        brandDesc2: "Bihuo is an exchange that only gathers high-quality blockchain assets to the world, such as the recently very popular NFT-related projects, Metaverse, Web3, etc., which are all areas that our insight team tracks daily. One of our missions is to only introduce \"high-quality blockchain asset projects\". The founding team of Bihuo comes from the internal developers of 8-year-old exchanges. We have rich experience in operating exchanges and are committed to building a strong, Safe and stable exchange to users around the world.",
        brandDesc3: "",
        gettingstart: "Novice | Study",
        officialstart: "Coin Trading learning",
        oneminutebuy: "What is a cryptocurrency",
        oneminutebuytips: "Learn about cryptocurrency in 3 minutes",
        baseknow: "Bihuo New User Guide",
        baseknowtips: "Start your journey anytime, anywhere",
        baseexchange: "Digital Asset Purchase",
        baseexchangetips: "How to buy digital assets",
        usersocial: "partner mechanism",
        usersocialtips: "Become a Bihuo Partner",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by Bihuo, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    cexchange: {
        title: "BXT Activity",
        desc: "BXT Coin ● One-click ● Profit everyday",
        ...
        confirmmsg: "Are you sure to exchange BXT?",
        ok: "OK",
        cancel: "Cancel"
    },
    option: {
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of Bihuo.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（Bihuo）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with Bihuo trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1. In order to preach the concept of digital assets and expand the scale of users, Bihuo launched the [Promotion Partner] plan, which is effective for a long time.",
        ruletext2: "2. Inviting friends is divided into one levels. If A invites B, then B is A's first-level friend.",
        ruletext3: "3. When promoting friend registration, you need to pass the link provided by the inviter or manually enter the inviter's invitation code to become the inviter's first-level friend.",
        ruletext4: "4. The invitee registers through the inviter's invitation code, and the rebate incentive will take effect.",
        ruletext5: "",
        ruletext6: "5. The promotion rebate asset is the transaction fee of the lower-level friend's currency, and the rebate currency is the three major market base currencies, namely: USDT, BTC, ETH.",
        ruletext7: "6. The promotion rebate ratio is as follows: ",
        ruletext8: "7. The TOP10 or TOP100 of the promotion rebate rankings will receive additional rewards from Bihuo from time to time.",
        ruletext9: "8. If other activities conflict with the [Promotion Partner] activities, it will be decided after consultation whether to change it temporarily. I hope all partners will understand.",
        ruletext10: "",
        ruletext11: "9. The final interpretation right of this event belongs to Bihuo.",
        ruleexampletitle: "For Example：",
        ruleexamplecontent1: "If user Xiaoyan invites 100 first-level friends, then Xiaoyan has 100 first-level friends. If the average person trades 3000 yuan per day, then Xiaoyan's monthly income is about: (100*3000*0.001*30%) * 30 = 2700/month. ",
        ruleexamplecontent2: "",
        ...
        thanks: "Thank you for supporting Bihuo！",
        ...
        pt_tips: "If you have a good idea, please send an email to support@bihuo.exchange, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to Bihuo.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        finance: {
            ...
            withdraw: {
                ...
                pickup: 'Pick up',
                withdrawDisable: 'Suspend withdrawal',
                ...
                moneyttip: 'The withdrawal amount must be greater than the handling fee',
                moneyminttip: 'The minimum withdrawal amount is',
                moneymaxttip: 'The maximum withdrawal amount is',
                shenqing: 'Withdrawal application has been submitted',
        ...
        safe: {
            ...
            idcard_verifymsg1: "1. The file is less than 2M.The information on the document should be clearly visible, no modifications in the document or cover by the foreign objects is allowed, and the document number and name should be visible.",
            ...
            idcard_verifymsg3: "3. Need to hold both hand-held documents and handwritten copy (BinaricX+name + application date), 'All my actions on this site are my own operations, and I understand the risks involved and willing to bear all the legal consequences of this account.'"
        },
        account: {
        ...
        identity: {
            ...
            become: "Become eotech Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "eotech APP - Trade everywhere."
    },
    description: {
        title1: 'Featured Digital Assets',
        title2: 'security of funds',
        title3: 'Fast transaction deposit and withdrawal system',
        title4: '24*7 hours customer service support',
        message1: 'Users will only trade high-quality blockchain projects that have been screened by Bihuo’s professional analysis team。',
        message2: 'The security of funds for Bihuo users comes from our mature fund separation system。',
        message3: 'We attach great importance to the speed of customer deposits and withdrawals, and the system of Bihuo works in real time 24 hours a day.',
        message4: 'User first is one of our core business philosophy of Bihuo, and we provide 24/7 customer service support.',
        scanqrcode: "Scan QR code, Download APP",
        aboutdesc1: "BinaricX's core mission is to provide safe, fair and easy-to-use digital asset trading services to provide a reliable and comfortable investment trading environment for global digital asset trading users.",
        aboutdesc2: "The field of digital assets changes with each passing day. Only with foresight and swift progress can we keep up with the rapid technological innovation. BinaricX provides our users and global investors with the most advanced digital asset trading services and businesses.",
        aboutdesc3: "BinaricX has established a solid and reliable foundation and is ready for future development. We will focus on the advantages of more digital financial systems on the platform, and provide users around the world with digital subscriptions, legal currency, currency and financial derivatives and other digital transactions. Service, and continuity to bring a new experience to users. ",
        support: "Support",
        report: "Suggestion",
        service: "Customer Service",
        apply: "Board Apply",
        coop: "Cooperation",
        community: "eotech Community",
        wechat: "Wechat",
        addwechat: "Add 'eotech01' as Wechat friends and then enter Wechat community",
        facebook: "Facebook",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        ...
        instagram: "Instagram",
        reddit: "Reddit",
        download1: "Anytime, anywhere, multi-platform terminal trading",
        download2: "Covering multiple platforms of iOS and Android, supporting full business functions",
    },
    bzb_description: {
        title1: "",
        title2: "",
    ...
    footer: {
        ...
        notice: 'Announcement',
        gsmc: 'Global digital currency trading platform',
        bah: 'No. 13026899 -3, Shanghai ICP',
        gsjj: 'Profile',
        gywm: 'About Us',
        feilv: 'Rate',
        jrwm: 'Client Downloads',
        biyong: 'BiYong',
        lxwm: 'Contact us',
        yqlj: 'Links',
        bzzx: 'Support',
        ...
        ptsm: 'Explain',
        fysm: 'Fees',
        fwtk: 'User Agreement and Privacy Policy',
        fltk: 'legal Policy',
        ...
        mztk: "Disclaimer",
        ystk: "Privacy Policy",
        tkxy: "Terms of service",
        gybzb: "About BZB",
        kfyx: "Customer service",
        swhz: "Cooperation",
        sbsq: "Market Application",
        jyzn: "Exchange Guide",
        bzzl: "Crypto introduction",
        tsjb: "Report",
        apidoc: "Api Doc",
        zwkf: "come soon",
        hqjs: "Market technology",
        other: "Other",
        kolhz: "KOL cooperation",
        mthz: "Media cooperation",
        tsyjy: "Complaints and Suggestions",
        sq: "Community",
    },
    index: {
        ...
        BHBregister: "eotech account registration",
        ...
        fenpeijizhi: 'A description of the eotech income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, eotech will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
