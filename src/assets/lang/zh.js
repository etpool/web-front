module.exports = {
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于币火",
        brandDetail: "币火团队拥有敏锐的洞察力并只把优质的区块链资产带入币火生态中",
        brandDesc1: "",
        brandDesc2: "币火是一家只聚集优质区块链资产面并向全球的交易所，像是近期非常热门的NFT相关项目、元宇宙、Web3等等，都是我们洞察团队每日追踪的领域之一，而我们的使命之一是只会引进“优质的区块链资产项目” ，币火的创办团队来自8年老牌交易所的内部开发人员，我们拥有丰富经营交易所的经验并致力于打造一个强大，安全与稳定的交易所给全球的用户。",
        brandDesc3: "",
        gettingstart: "新手指引 | 极速学习",
        officialstart: "即刻开启数字货币交易学习",
        oneminutebuy: "什么是加密货币",
        oneminutebuytips: "3分钟了解加密货币",
        baseknow: "币火新用户指导",
        baseknowtips: "随时随地开始你的旅程",
        baseexchange: "数字资产购买",
        baseexchangetips: "如何购买数字资产",
        usersocial: "合伙人机制",
        usersocialtips: "成为币火合伙人",
        mainboard: "主板交易区",
        preview: "上一页",
        nextpage: "下一页",
    ...
    swap: {
        ...
        levmaxtip: "杠杆倍数不能高于最高倍数",
        levmintip: "杠杆倍数不能低于最低倍数",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归Bihuo官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与",
        tipsmobile1: "请在电脑端打开并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"Bihuo的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与Bihuo交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，Bihuo推出【推广合伙人】计划，该活动长期有效。",
        ruletext2: "二、邀请好友分为一级，如A邀请B，则B是A的一级好友",
        ruletext3: "三、推广好友注册时，需通过邀请者提供的链接或手动输入邀请者邀请码方可成为邀请者的一级好友。",
        ruletext4: "四、被邀请者通过邀请者邀请码注册，返佣激励方可生效。",
        ruletext5: "",
        ruletext6: "五、推广返佣资产为下级好友币币交易手续费，返佣币为三大市场基础币，即：USDT、BTC、ETH。",
        ruletext7: "六、推广返佣比例如下：",
        ruletext8: "七、推广返佣排行榜TOP10或TOP100不定期会获得由Bihuo官方发放的额外奖励。",
        ruletext9: "八、如其他活动与【推广合伙人】活动冲突，则经协商后决定是否临时变更，望诸合伙人谅解。",
        ruletext10: "",
        ruletext11: "九、本活动最终解释权归Bihuo所有。",
        ruleexampletitle: "举例说明：",
        ruleexamplecontent1: "若用户小严邀请了100名一级好友，此时小严就拥有100名一级好友。如果平均每人每天交易3000元，那么小严月收入约：(100*3000*0.001*30%) * 30 = 2700/月。",
        ruleexamplecontent2: "",
        lastupdate: "最后更新于",
        laststastic: "统计截止时间",
        level: "级别",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由Bihuo官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归Bihuo所有。",
        pt_card_day: "天",
    ...
    uc: {
        ...
        finance: {
            ...
            withdraw: {
                ...
                numtip3: '提币数量不得小于手续费',
                amounttip: '请输入提币数量',
                moneyttip: '提币数量必须大于手续费',
                moneyminttip: '最小提现金额为',
                moneymaxttip: '最大提现金额为',
                shenqing: '提币申请已提交',
                feetip1: '手续费最小值为',
                feetip2: '最大值为',
                time: '提现时间',
        ...
        safe: {
            ...
            save_success: '保存成功!',
            save_failure: '保存失败!',
            idcard_verifymsg1: "1、支持JPG、PNG格式，文件小于2M；证件上的信息，清晰可见，不允许任何修改和遮挡，必须能看清证件号和姓名。",
            idcard_verifymsg2: "2、照片需免冠，建议未化妆，手持证件人的五官清晰可鉴，完整露出手臂。",
            idcard_verifymsg3: "3、需要同时手持证件和手写文案（Bihuo+姓名+申请日期）'我在本站的所有行为均为本人操作，并已知悉相关风险，愿意承担本账户的一切法律后果。'"
        },
        account: {
            pagetitle: '绑定实名帐号',
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "Bihuo APP - 全球数字资产交易平台"
    },
    description: {
        title1: '精选数字资产',
        title2: '资金的安全保障',
        title3: '快捷的交易充提系统',
        title4: '24*7小时客服支持',
        message1: '用户只会交易经由币火专业的分析团队筛选后优质的区块链项目。',
        message2: '币火用户的资金安全性来自于我们成熟的资金分离系统。',
        message3: '客户充提的速度是我们很重视的，币火的系统24小时实时工作。',
        message4: '用户第一是我们币火的经营核心理念之一，我们提供全天24小时的客服支持。',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "Bihuo以安全，公平，易用的数字资产交易服务为核心使命，为全球数字资产交易用户提供可信赖的舒适投资交易环境。",
        aboutdesc2: "数字资产领域日新月异，唯有高瞻远瞩、迅捷前行才能跟上迅猛的科技创新，Bihuo为我们的用户及全球投资者提供最先进的数字资产交易服务以及业务。",
        aboutdesc3: "Bihuo建立了坚实可靠的基础，为未来的发展做好准备，我们将会聚焦更多数字金融体系的优势于平台，为全球用户提供数字申购，法币，币币及金融衍生品等数字交易服务，并持续性为用户带来全新体验。",
        support: "技术支持",
        report: "投诉建议",
        service: "客户服务",
        apply: "上币申请",
        ...
        community: "Bihuo社区",
        wechat: "微信",
        addwechat: "添加 “eotech01” 为微信好友，进入微信福利社群",
        facebook: "面子书",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        ...
        instagram: "Instagram",
        reddit: "Reddit",
        download1: "随时随地 多平台终端交易",
        download2: "覆盖iOS、Android多个平台，支持全业务功能",
    },
    bzb_description: {
        title1: "分红权益",
        title2: "手续费折扣",
        ...
        desc4: "参与Bihuo社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "Bihuo账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于Bihuo收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，Bihuo会拿出平台的80% (扣除税费后) 的收入分配给BinaricX持有者，20%的收入用来支持平台的研发及运营。",
